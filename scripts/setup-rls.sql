...
--
-- Si las políticas ya existen, los DROP POLICY IF EXISTS al inicio
-- de cada bloque las eliminan antes de recrearlas.
--
...
BEGIN
  ...
  VALUES ('Propiedades Sosa', 'propiedades-sosa', 'esencial', 'active', 50)
...
-- =============================================
-- 1. Habilitar RLS en las tablas del plan Esencial
-- =============================================
...
-- =============================================
-- ISR — columnas requeridas en tenants
-- =============================================
